  ...
  return (
    <footer className="max-container">
      ...
      <div className="flex justify-between text-white-400
        ...
        <div className="flex flex-1 justify-startitems-center gap-2 font-montserrat cursor-pointer">
          <img
            src={copyrightSign}
            alt="copy right sign"
            width={20}
